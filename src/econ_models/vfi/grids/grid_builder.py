...
class GridBuilder:
    ...
    def build_capital_grid(
        ...
        default_scale: Tuple[float, float] = (0.1, 10.0)
    ) -> Tuple[Tensor, float]:
        """
        ...
        Args:
            ...
            custom_bounds: Optional custom (min, max) bounds.
            use_log_spacing: Whether to use logarithmic spacing.
            default_scale: Default (min, max) scale relative to steady state.
        ...
        if custom_bounds:
            ...
            k_min_val = default_scale[0] * k_ss
            k_max_val = default_scale[1] * k_ss
    ...
    def build_debt_grid(
        ...
        k_ss: float,
        custom_bounds: Optional[Tuple[float, float]] = None,
        default_scale: Tuple[float, float] = (0.0, 15.0)
    ) -> Tensor:
        """
        ...
        Args:
            ...
            custom_bounds: Optional custom (min, max) bounds.
            default_scale: Default (min, max) scale relative to k_ss.
        ...
        if custom_bounds:
            ...
            b_min_val = default_scale[0] * k_ss
            b_max_val = default_scale[1] * k_ss
    ...
    def _build_log_spaced_grid(
        ...
        log_min = tf.math.log(tf.cast(min_val, TENSORFLOW_DTYPE))
