...
class EconomicParams:
    ...
    productivity_persistence: float
    productivity_std_dev: float
    adjustment_cost_convex: float
    adjustment_cost_fixed: float
    equity_issuance_cost_fixed: float
    equity_issuance_cost_linear: float
    default_cost_proportional: float
